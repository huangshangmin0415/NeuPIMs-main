...
class NeuPIMSCore {
   ...
   protected:
    ...
    std::queue<MemoryAccess *> _memory_request_queue;  // not used
    std::queue<MemoryAccess *> _memory_response_queue;  // not used neither
